								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2"> Foods</p>
												<span class="title text-black font-w600">{{foods()->count()}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2"> Chefs</p>
												<span class="title text-black font-w600">{{chefs()->count()}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2"> Messages</p>
												<span class="title text-black font-w600">{{messages()->count()}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card">
									<div class="card-header d-sm-flex d-block pb-0 border-0">
										<div class="mr-auto pr-3">
											<h4 class="text-black font-w600 fs-20">All Admin <span class="text-danger">{{users()->count()}}</span></h4>
