...
<head>
	...
	<link href="{{asset('dashboard/vendor')}}/toastr/css/toastr.min.css" rel="stylesheet">
    ...
    ***********************************-->
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('adminprofile')}}" class="dropdown-item ai-icon">
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                      ...
                                      <i class="flaticon-381-enter"></i>  logout
                                    </a>
    ...
    @include('layouts.dashboard.partial.sidemenu')
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="javascript:void(0)" >Jahin</a> {{date('Y')}}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
